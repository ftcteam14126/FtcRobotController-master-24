...
@Autonomous(name="FibbyAuto24Red", group="Robot")
@Disabled
public class FibbyAuto24Red extends LinearOpMode {
    //----------------------------------------------------------------------------------------------------
    ...
    private static final String TFOD_MODEL_ASSET = "RedLeft.tflite";
    ...
    public void runOpMode() {
        ...
        while (!isStarted()) {
            ...
            if(TSEplacement == 1){
                telemetry.addLine("TSE == 1");
            }
            else if (TSEplacement == 2){
                telemetry.addLine("TSE == 2");
            }
            else if (TSEplacement == 3){
                telemetry.addLine("TSE == 3");
            }
            else{
                telemetry.addLine("TSE == 0");
            }
            telemetryTfod();
